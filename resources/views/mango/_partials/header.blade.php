	...
	<header class="type-4">
		<div class="header-top">
			<div class="header-top-entry">
				<div class="title"><img src="mango/img/flag-lang-1.png" alt="" />English<i class="fa fa-caret-down"></i></div>
				<div class="list">
					<a href="#" class="list-entry"><img src="mango/img/flag-lang-2.png" alt="" />French</a>
					<a href="#" class="list-entry"><img src="mango/img/flag-lang-3.png" alt="" />Spanish</a>
				</div>
			</div>
			<div class="header-top-entry">
		...
		<div class="header-middle">
			<div class="logo-wrapper">
				<a id="logo" href="#"><img src="mango/img/logo-15.png" alt="" /></a>
			</div>
				...
				<nav>
					<ul>
									...
									<div class="menu-slider-out">
										<div class="menu-slider-in">
											<div class="menu-slider-entry">
												<div class="product-slide-entry">
													<div class="product-image">
														<img src="mango/img/product-minimal-1.jpg" alt="" />
											...
											<div class="menu-slider-entry">
												<div class="product-slide-entry">
													<div class="product-image">
														<img src="mango/img/product-minimal-2.jpg" alt="" />
														<div class="bottom-line left-attached">
															<a class="bottom-line-a square"><i class="fa fa-shopping-cart"></i></a>
															<a class="bottom-line-a square"><i class="fa fa-heart"></i></a>
															<a class="bottom-line-a square"><i class="fa fa-retweet"></i></a>
											...
											<div class="menu-slider-entry">
												<div class="product-slide-entry">
													<div class="product-image">
														<img src="mango/img/product-minimal-3.jpg" alt="" />
														<div class="bottom-line left-attached">
															<a class="bottom-line-a square"><i class="fa fa-shopping-cart"></i></a>
															<a class="bottom-line-a square"><i class="fa fa-heart"></i></a>
															<a class="bottom-line-a square"><i class="fa fa-retweet"></i></a>
											...
											<div class="menu-slider-entry">
												<div class="product-slide-entry">
													<div class="product-image">
														<img src="mango/img/product-minimal-4.jpg" alt="" />
														<div class="bottom-line left-attached">
															<a class="bottom-line-a square"><i class="fa fa-shopping-cart"></i></a>
															<a class="bottom-line-a square"><i class="fa fa-heart"></i></a>
															<a class="bottom-line-a square"><i class="fa fa-retweet"></i></a>
											...
											<div class="menu-slider-entry">
												<div class="product-slide-entry">
													<div class="product-image">
														<img src="mango/img/product-minimal-5.jpg" alt="" />
														<div class="bottom-line left-attached">
															<a class="bottom-line-a square"><i class="fa fa-shopping-cart"></i></a>
															<a class="bottom-line-a square"><i class="fa fa-heart"></i></a>
															<a class="bottom-line-a square"><i class="fa fa-retweet"></i></a>
						...
						<li class="full-width-columns">
							...
							<div class="submenu">
								<div class="product-column-entry">
									<div class="image"><img alt="" src="mango/img/product-menu-2.jpg"></div>
								...
								<div class="product-column-entry">
									<div class="image"><img alt="" src="mango/img/product-menu-4.jpg"></div>
								...
								<div class="product-column-entry">
									<div class="image"><img alt="" src="mango/img/product-menu-3.jpg"></div>
								...
								<div class="product-column-entry">
									<div class="image"><img alt="" src="mango/img/product-menu-5.jpg"></div>
						...
						<li class="column-1">
							...
							<div class="submenu">
								<div class="full-width-menu-items-left">
									<img class="submenu-background" src="mango/img/product-menu-7.jpg" alt="" />
									<div class="row">
										<div class="col-md-12">
						...
						<li class="column-1">
							...
							<div class="submenu">
								<div class="full-width-menu-items-left">
									<img class="submenu-background" src="mango/img/product-menu-8.jpg" alt="" />
									<div class="row">
										<div class="col-md-12">
					...
					<a class="fixed-header-visible additional-header-logo"><img src="mango/img/logo-15.png" alt=""/></a>
				</nav>
